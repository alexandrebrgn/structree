  ...
  return (
    <div className="w-full h-auto flex justify-between border-t p-4">
      ...
      <div className="flex gap-6">
        ...
        {/* Instagram */}
        <div className="flex align-middle items-center gap-1">
          <div className="h-8 w-8 flex items-center justify-center rounded-4xl bg-linear-to-br from-[rgba(252,241,0,1)] via-[rgba(255,0,254,1)] to-[rgba(0,142,255,1)] text-white">
            <InstagramIcon/>
          </div>
          <p>Instagram</p>
        </div>
